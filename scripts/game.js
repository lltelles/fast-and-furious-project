class Game {
    ...
    updateBackground() {
      ...
      this.ctx.drawImage(img, 0, this.bckgY-this.height+40, this.width, this.height - 40);
      if(this.level===1){this.bckgY+=2;};
      if(this.level===2){this.bckgY+=4;};
      if(this.level===3){this.bckgY+=5;}
